...
def procesar_cfdi(xml_content, rfc_activo):
    try:
        ...
        return {
            ...
            "emisor_rfc": rfc_emisor,      # Corregido al nombre de columna real en Supabase
            "receptor_rfc": rfc_receptor,  # Corregido al nombre de columna real en Supabase
...
# Aislamiento de Datos por RFC corregido para buscar emisor_rfc y receptor_rfc
if 'emisor_rfc' in df_filtrado_fecha.columns and 'receptor_rfc' in df_filtrado_fecha.columns:
    df_entorno = df_filtrado_fecha[(df_filtrado_fecha['emisor_rfc'].str.upper() == RFC_ACTIVO) | (df_filtrado_fecha['receptor_rfc'].str.upper() == RFC_ACTIVO)]
else:
    if perfil_activo == "Operación Nicole":

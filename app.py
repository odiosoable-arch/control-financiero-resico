...
if df.empty:
    ...
    if not ingresos_df.empty:
        ...
        for idx, row in ingresos_df.iterrows():
            ...
            iva = row['impuestos']
            total_factura_banco = subtotal + iva  # <--- TOTAL QUE CAE A CUENTA BANCARIA
            ...
            datos_socios_publico.append({
                ...
                "Total Factura (Banco)": total_factura_banco,  # <--- NUEVA COLUMNA VISUAL
    ...
    # --- NUEVA PESTAÑA: RETIROS SOCIO MAYORISTA (EXCLUSIÓN DE PAGADAS Y DESCARGA CSV) ---
